        ...
        >
            <div className="grid grid-cols-1 gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        <div className="bg-[#1e2738] text-white text-sm   px-2 py-1">Nombre</div>
                        <input
                            type="text"
                            name="name"
                            value={form.name}                         
                    ...
                    <div>
                        <div className="bg-[#1e2738] text-white text-sm   px-2 py-1">Direccion</div>
                        <input
                            type="text"
                            name="address"
                            value={form.address}
                ...
                {/* Personal, Trabajo y Personal */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">

                    <div>
                        <div className="bg-[#1e2738] text-white text-sm px-2 py-1">Telefono Celular</div>
                        <input
                            type="text"
                            name="cellphone"
                    ...
                    <div>
                        <div className="bg-[#1e2738] text-white text-sm px-2 py-1">Telefono Trabajo</div>
                        <input
                            type="text"
                            name="work_phone"
                    ...
                    <div>
                        <div className="bg-[#1e2738] text-white text-sm px-2 py-1">Telefono Personal</div>
                        <input
                            type="text"
                            name="personal_phone"
                ...
                <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div className="col-start-1 col-end-3">
                        <div className="bg-[#1e2738] text-white text-sm px-2 py-1">Email</div>
                        <input
                            type="text"
                            name="email"
                            value={form.email}
                    ...
                    <div className="col-span-2 col-end-7">
                        <div className="bg-[#1e2738] text-white text-sm px-2 py-1">Contacto</div>
                        <input
                            type="text"
                            name="contact"
                            value={form.contact}
